...
selected <- read_tsv('raw_results.tsv')
all_data <- read_tsv('merged_assembly_stats.tsv')
...
obj %>%
  ...
  heat_tree(
    ...
    node_color = ifelse(taxon_ids %in% selected_taxa, '#888888', '#DDDDDD'),
